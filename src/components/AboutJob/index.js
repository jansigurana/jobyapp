...
class AboutJob extends Component {
            ...
            <div className="first-part-container">
              ...
              <div className="location-package-container">
                <div className="location-job-type-container">
                  ...
                  <div className="employment-type-icon-employment_type-container">
  ...
  renderJobFailureView = () => (
    <div className="job-details-failure-view">
      ...
      <p>we cannot stem to find the page you are looking for.</p>
  ...
  renderJobLoadingView = () => (
    <div className="job_details-loader" data-testid="loader">
